...
function runBaseTests() {
  px_kpi_1 = document.getElementById('px_kpi_1');

  suite('Base Automation Tests for px-kpi', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-kpi fixture is created', function() {
      assert.isTrue(document.getElementById('px_kpi_1') !== null);
    });
